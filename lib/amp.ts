...
export const AMP_CATEGORIES: AmpCategory[] = [
  {
    ...
    icon: '◈',
    fields: [
      { key: 'passportValidity', label: 'Passport validity', low: 'Expired or expiring', high: '5+ years left' },
      { key: 'visaStatus', label: 'Active visa coverage', low: 'None', high: 'Multi-year, multi-region' },
      { key: 'linkedNationalId', label: 'Linked national ID', low: 'Not linked', high: 'Verified, linked' },
      { key: 'documentCompleteness', label: 'Document completeness', low: 'Missing key docs', high: 'All required docs current' },
      { key: 'emergencyVerification', label: 'Emergency verification', low: 'Not set up', high: 'Contacts verified' },
    ],
  },
  {
    key: 'compliance',
    ...
    icon: '◇',
    fields: [
      { key: 'overstayRecords', label: 'Overstay records', low: 'Multiple overstays', high: 'No overstays' },
      { key: 'borderViolations', label: 'Border violations', low: 'Several violations', high: 'Clean record' },
      { key: 'customsPenalties', label: 'Customs penalties', low: 'Past penalties', high: 'No penalties' },
      { key: 'fraudAttempts', label: 'Document fraud flags', low: 'Flagged', high: 'No flags' },
      { key: 'entryDenials', label: 'Entry denial history', low: 'Multiple denials', high: 'No denials' },
    ],
  },
  {
    key: 'reliability',
    ...
    fields: [
      ...
      { key: 'lateCheckIns', label: 'Late check-ins', low: 'Routinely late', high: 'Always on time' },
      { key: 'cancellationFreq', label: 'Cancellation frequency', low: 'Frequent cancels', high: 'Almost never' },
      { key: 'returnPunctuality', label: 'Return punctuality', low: 'Often delayed', high: 'Always on schedule' },
    ],
  },
  {
    key: 'financial',
    ...
    fields: [
      ...
      { key: 'savingsRatio', label: 'Savings ratio', low: 'Live paycheck-to-paycheck', high: '6+ months runway' },
      { key: 'creditHealth', label: 'Credit health', low: 'Poor', high: 'Excellent' },
      { key: 'insuranceActive', label: 'Travel insurance', low: 'None', high: 'Active, comprehensive' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'sharedMobility', label: 'Shared mobility usage', low: 'Solo cars', high: 'Mostly shared' },
  ...
  },
  {
    ...
    icon: '◉',
    fields: [
      { key: 'avgSpend', label: 'Average spend per trip', low: 'Minimal', high: 'High contribution' },
      { key: 'lengthOfStay', label: 'Average length of stay', low: '1–2 days', high: '2+ weeks' },
      { key: 'businessPurpose', label: 'Business / professional travel', low: 'Never', high: 'Routinely' },
      { key: 'skillRelevance', label: 'Skill demand relevance', low: 'No declared skills', high: 'High-demand skills' },
      { key: 'tourismContribution', label: 'Tourism contribution', low: 'Pass-through', high: 'Engaged contributor' },
    ],
  },
];
...
export function categoryScore(profile: AmpProfile, categoryKey: string): { score: number; max: number } {
...
export const TIER_META: Record<Tier, TierMeta> = {
  ...
  2: {
    ...
    perks: ['Selected destinations', 'Delayed approvals', 'Route restrictions', 'Additional requirements'],
    color: '#cc9900',
  },
  1: {
    tier: 1,
